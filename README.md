...
3. For **Windows XP**, you need to install the **Supermium browser**. Follow these steps to download and install Supermium:
    ...
    - Go to the [Supermium v.122 release page](https://github.com/win32ss/supermium/releases/tag/v122-r6) on GitHub
    - Select and download the .exe file appropriate for your operating system architecture (32-bit or 64-bit).
    - Locate the downloaded .exe file and double-click to start the installation. Follow the on-screen instructions to complete the installation process.
    - During installation, select the "**Create shortcuts**" checkbox for easier access to the app after installation.
